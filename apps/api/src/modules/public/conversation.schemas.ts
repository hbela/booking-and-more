...
export const conversationChannelSchema = z.literal("CHAT");
...
export const createConversationBodySchema = z.object({
  ...
  /** Accepted once from the existing secure management screen, never persisted. */
  managementToken: z.string().min(20).max(200).optional(),
});
